        ...
        <div>
            <div className="max-w-screen-2xl mx-auto mb-30 px-5 md:px-0">
                <div className="mt-20">
                    ...
                    <Image height={100} className="mx-auto mt-20 w-2/12 h-full object-container mb-10" alt="grupo-palante" src={grupoPalante} />
                    ...
                    <div className="grid md:grid-cols-3 gap-10 mt-16">
                        <div>
                            <Image className="mx-auto h-9/12 w-8/12 object-container" alt="grupo-palante" src={papymes} />
                            <p className="text-center text-[#5C5C5C]">Préstamos para las PYMES (PaPymes) y préstamos vehiculares (PaMotors).</p>
                        </div>
                        <div>
                            <Image className="mx-auto h-9/12 w-8/12 object-container" alt="grupo-palante" src={pafactoring} />
